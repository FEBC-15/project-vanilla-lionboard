...
```sh
npx degit https://github.com/FEBC-API/APIServer/api/dbinit dbinit-sample
```
...
```sh
npx degit https://github.com/FEBC-API/APIServer/api/bruno bruno-sample
```
